...
mixin _$HomeState {
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<Product> products, List<Product> filteredProducts,
            List<Product> wishlist, String? searchText)?
        success,
...
class _$HomeSuccessImpl implements HomeSuccess {
  ...
  @override
  String toString() {
    return 'HomeState.success(products: $products, filteredProducts: $filteredProducts, wishlist: $wishlist, searchText: $searchText)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return success(products, filteredProducts, wishlist, searchText);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return success?.call(products, filteredProducts, wishlist, searchText);
  }
...
abstract class HomeSuccess implements HomeState {
  const factory HomeSuccess(
      ...
      final String? searchText}) = _$HomeSuccessImpl;
...
abstract class HomeError implements HomeState {
  const factory HomeError({required final String message}) = _$HomeErrorImpl;
